      ...
      <div className="row justify-content-center g-4">
        <div className="col-12 col-sm-6 col-md-4 col-lg-3">
          <div className="p-3 rounded" style={{ background: 'white' }}>
            <img src='/public/icons/Icon4.png' style={{ height: '40px', width: '40px', marginBottom: '12px' }} alt="" />
        ...
        <div className="col-12 col-sm-6 col-md-4 col-lg-3">
          <div className="p-3 rounded" style={{ background: '#ECF4FE' }}>
            <img src='/public/icons/Icon8.png' style={{ height: '40px', width: '40px', marginBottom: '12px' }} alt="" />
            <h6>Job Search</h6>
            <p style={{ fontSize: '14px' }}>
        ...
        <div className="col-12 col-sm-6 col-md-4 col-lg-3">
          <div className="p-3 rounded" style={{ background: 'white' }}>
            <img src='/public/icons/Icon5.png' style={{ height: '40px', width: '40px', marginBottom: '12px' }} alt="" />
        ...
        <div className="col-12 col-sm-6 col-md-4 col-lg-3">
          <div className="p-3 rounded" style={{ background: 'white' }}>
            <img src='/public/icons/Icon3.png' style={{ height: '40px', width: '40px', marginBottom: '12px' }} alt="" />
